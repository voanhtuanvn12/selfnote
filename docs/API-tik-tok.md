...
Max delivery & Creative boost (trong campaign — thuật ngữ TikTok API; **SmartAds RunAllVideos** dùng **Target ROI** / ROAS bid cho campaign chính, xem [SmartAds-RunAllVideos-Flow.md](SmartAds-RunAllVideos-Flow.md))
