...
| Tạo camp GMV Max lần đầu (`create`), **20% MDB**, `roas_bid` = ROAS hòa vốn, tên `ZZP` | Có — P1-BE-09, 16–18; P1-FE-04, 05, 10 | Payload **RunAllVideos** / Max Delivery khác — [SmartAds-RunAllVideos-Flow.md](SmartAds-RunAllVideos-Flow.md); [ADR 0001](adr/0001-smartads-phase1-tiktok-create-payload.md) |
